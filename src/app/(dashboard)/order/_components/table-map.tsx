...
export function TableNode({ data }: { data: { label: string; capacity: number; status: string } }) {
  return (
    <HoverCard>
      <HoverCardTrigger asChild>
        <div
          className={cn(
            "bg-muted rounded-lg flex items-center justify-center outline-2 outset-4 outline-dashed",
            {
